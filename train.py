...
NUM_EPOCHS = 30                # TUNE: 训练轮数(更多 epoch = 更好精度,更贵)
...
last_train_acc = 0.0
last_val_acc = 0.0             # 自己切的 val set 精度 —— 这把尺子模型没碰过
...
train_transform = transforms.Compose([
    ...
    transforms.RandomRotation(15),               # TUNE: 旋转增强
...
print(f"  类别数: {len(full_train_ds.classes)} (classes[0]={full_train_ds.classes[0]})")
